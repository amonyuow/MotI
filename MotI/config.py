...
TITLE_MUSIC_PATH = os.path.join(_PROJECT_DIR, "assets", "Studlands OST - Max's Inn.mp3")

# Boss fight music (plays during the fight).
BOSS_FIGHT_MUSIC_PATH = os.path.join(_PROJECT_DIR, "assets", "audiomass-output.mp3")
